  ...
  <body>
    ...
    <script>
      ...
      class SlidePresentation {
        ...
        setupMeta() {
          // Ensure exported/generated HTML always exposes page count and notes.
          window.__META__ = {
            ...(window.__META__ || {}),
...
3. **Global Metadata Object** — Must define:
   - `window.__META__`
   - `window.__META__.totalPageNum` (total number of `.slide` pages)
   - `window.__META__.notes` (speaker note list for every page, index-aligned)
