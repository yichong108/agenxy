...
Thank you for your interest in **Openwork**. This document explains how to set up your environment, submit changes, and follow project conventions when working with maintainers.
